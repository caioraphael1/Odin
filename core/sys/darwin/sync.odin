...
when DUSK_OS == .Darwin {
	when DUSK_PLATFORM_SUBTARGET_IOS {
		WAIT_ON_ADDRESS_AVAILABLE :: DUSK_MINIMUM_OS_VERSION >= 17_04_00
		ULOCK_WAIT_2_AVAILABLE    :: DUSK_MINIMUM_OS_VERSION >= 14_00_00
	} else {
		WAIT_ON_ADDRESS_AVAILABLE :: DUSK_MINIMUM_OS_VERSION >= 14_04_00
		ULOCK_WAIT_2_AVAILABLE    :: DUSK_MINIMUM_OS_VERSION >= 11_00_00
	}
} else {
