...
foreign Foundation {
    ...
    __objc_allocateClassPair      :: proc(superclass: Class, name: cstring, extraBytes: c.size_t) -> Class ---
    __objc_registerClassPair        :: proc(cls: Class) ---
    ...
    __sel_registerName            :: proc(name: cstring) -> SEL ---
    sel_getName                   :: proc(sel: SEL) -> cstring ---
    sel_isEqual                   :: proc(lhs, rhs: SEL) -> BOOL ---

    __class_addMethod               :: proc(cls: Class, name: SEL, imp: IMP, types: cstring) -> BOOL ---
    ...
    __class_getInstanceVariable     :: proc(cls: Class, name: cstring) -> Ivar ---
    __class_addIvar                 :: proc(cls: Class, name: cstring, size: c.size_t, alignment: u8, types: cstring) -> BOOL ---
    ...
    __object_getClass             :: proc(obj: id) -> Class ---
    ...
    __ivar_getOffset                :: proc(v: Ivar) -> c.ptrdiff_t ---
}
