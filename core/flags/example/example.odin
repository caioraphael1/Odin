...
main :: proc() {
    Options :: struct {
        ...
        todo: dyn_array.Dyn_Array(string) `usage:"Todo items."`,
        ...
        // gadgets: dyn_array.Dyn_Array(string) `args:"required=1" usage:"gadgets"`,
        // widgets: dyn_array.Dyn_Array(string) `args:"required=<3" usage:"widgets"`,
        // foos: dyn_array.Dyn_Array(string) `args:"required=2<4"`,
        // bars: dyn_array.Dyn_Array(string) `args:"required=3<4"`,
        // bots: dyn_array.Dyn_Array(string) `args:"required"`,
        ...
        // bots: dyn_array.Dyn_Array(string) `args:"manifold=2,required"`,

        verbose: bool `usage:"Show verbose output."`,
        debug: bool `args:"hidden" usage:"print debug info"`,

        overflow: dyn_array.Dyn_Array(string) `usage:"Any extra arguments go here."`,
    }
