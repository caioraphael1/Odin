...
get_u32 :: proc(b: []u8, order: Byte_Order) -> (v: u32, ok: bool) {
	if len(b) < 4 {
		return 0, false
	}
	if order == .Little {
...
get_u64 :: proc(b: []u8, order: Byte_Order) -> (v: u64, ok: bool) {
	if len(b) < 8 {
		return 0, false
	}
	if order == .Little {
...
get_i16 :: proc(b: []u8, order: Byte_Order) -> (i16, bool) {
	v, ok := get_u16(b, order)
	return i16(v), ok
}
get_i32 :: proc(b: []u8, order: Byte_Order) -> (i32, bool) {
	v, ok := get_u32(b, order)
	return i32(v), ok
}
get_i64 :: proc(b: []u8, order: Byte_Order) -> (i64, bool) {
	v, ok := get_u64(b, order)
	return i64(v), ok
}

get_f16 :: proc(b: []u8, order: Byte_Order) -> (f16, bool) {
	v, ok := get_u16(b, order)
	return transmute(f16)v, ok
}
get_f32 :: proc(b: []u8, order: Byte_Order) -> (f32, bool) {
	v, ok := get_u32(b, order)
	return transmute(f32)v, ok
}
get_f64 :: proc(b: []u8, order: Byte_Order) -> (f64, bool) {
	v, ok := get_u64(b, order)
	return transmute(f64)v, ok
}

unchecked_put_u16le :: #force_inline proc(b: []u8, v: u16) {
	intrinsics.unaligned_store((^u16)(raw_data(b)), bits.to_le_u16(v))
}
unchecked_put_u32le :: #force_inline proc(b: []u8, v: u32) {
	intrinsics.unaligned_store((^u32)(raw_data(b)), bits.to_le_u32(v))
}
unchecked_put_u64le :: #force_inline proc(b: []u8, v: u64) {
	intrinsics.unaligned_store((^u64)(raw_data(b)), bits.to_le_u64(v))
}
unchecked_put_u16be :: #force_inline proc(b: []u8, v: u16) {
	intrinsics.unaligned_store((^u16)(raw_data(b)), bits.to_be_u16(v))
}
unchecked_put_u32be :: #force_inline proc(b: []u8, v: u32) {
	intrinsics.unaligned_store((^u32)(raw_data(b)), bits.to_be_u32(v))
}
unchecked_put_u64be :: #force_inline proc(b: []u8, v: u64) {
	intrinsics.unaligned_store((^u64)(raw_data(b)), bits.to_be_u64(v))
}

put_u16 :: proc (b: []u8, order: Byte_Order, v: u16) -> bool {
	if len(b) < 2 {
		return false
	}
	if order == .Little {
...
put_u32 :: proc(b: []u8, order: Byte_Order, v: u32) -> bool {
	if len(b) < 4 {
		return false
	}
	if order == .Little {
...
put_u64 :: proc(b: []u8, order: Byte_Order, v: u64) -> bool {
	if len(b) < 8 {
		return false
	}
	if order == .Little {
...
put_i16 :: proc(b: []u8, order: Byte_Order, v: i16) -> bool {
	return put_u16(b, order, u16(v))
}
put_i32 :: proc(b: []u8, order: Byte_Order, v: i32) -> bool {
	return put_u32(b, order, u32(v))
}
put_i64 :: proc(b: []u8, order: Byte_Order, v: i64) -> bool {
	return put_u64(b, order, u64(v))
}

put_f16 :: proc(b: []u8, order: Byte_Order, v: f16) -> bool {
	return put_u16(b, order, transmute(u16)v)
}
put_f32 :: proc(b: []u8, order: Byte_Order, v: f32) -> bool {
	return put_u32(b, order, transmute(u32)v)
}
put_f64 :: proc(b: []u8, order: Byte_Order, v: f64) -> bool {
