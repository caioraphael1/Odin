...
map_keys :: proc(m: $M/map[$K]$V, allocator: runtime.Allocator, loc := #caller_location) -> (keys: []K, err: runtime.Allocator_Error) {
...
map_values :: proc(m: $M/map[$K]$V, allocator: runtime.Allocator, loc := #caller_location) -> (values: []V, err: runtime.Allocator_Error) {
...
map_entries :: proc(m: $M/map[$K]$V, allocator: runtime.Allocator, loc := #caller_location) -> (entries: []Map_Entry(K, V), err: runtime.Allocator_Error) {
...
map_entry_infos :: proc(m: $M/map[$K]$V, allocator: runtime.Allocator, loc := #caller_location) -> (entries: []Map_Entry_Info(K, V), err: runtime.Allocator_Error) #no_bounds_check {
	m := m
