...
erf_f16   :: proc(x: f16)   -> f16   { return f16(erf_f64(f64(x))) }
erf_f16le :: proc(x: f16le) -> f16le { return f16le(erf_f64(f64(x))) }
erf_f16be :: proc(x: f16be) -> f16be { return f16be(erf_f64(f64(x))) }
erf_f32   :: proc(x: f32)   -> f32   { return f32(erf_f64(f64(x))) }
erf_f32le :: proc(x: f32le) -> f32le { return f32le(erf_f64(f64(x))) }
erf_f32be :: proc(x: f32be) -> f32be { return f32be(erf_f64(f64(x))) }
...
erf_f64 :: proc(x: f64) -> f64 {
    ...
    r := exp_f64(-z*z-0.5625) * exp_f64((z-x)*(z+x)+R/S)
    if sign {
        return r/x - 1
    }
    return 1 - r/x
...
erfc_f16   :: proc(x: f16)   -> f16   { return f16(erfc_f64(f64(x))) }
erfc_f16le :: proc(x: f16le) -> f16le { return f16le(erfc_f64(f64(x))) }
erfc_f16be :: proc(x: f16be) -> f16be { return f16be(erfc_f64(f64(x))) }
erfc_f32   :: proc(x: f32)   -> f32   { return f32(erfc_f64(f64(x))) }
erfc_f32le :: proc(x: f32le) -> f32le { return f32le(erfc_f64(f64(x))) }
erfc_f32be :: proc(x: f32be) -> f32be { return f32be(erfc_f64(f64(x))) }
