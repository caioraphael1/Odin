import "core:math"
 ...
 tan_half         :: proc "c" (x: half)    -> half { return math.tan(x) }
 acos_half        :: proc "c" (x: half)    -> half { return math.acos(x) }
 asin_half        :: proc "c" (x: half)    -> half { return math.asin(x) }
 atan_half        :: proc "c" (x: half)    -> half { return math.atan(x) }
 atan2_half       :: proc "c" (y, x: half) -> half { return math.atan2(y, x) }
 cosh_half        :: proc "c" (x: half)    -> half { return math.cosh(x) }
 sinh_half        :: proc "c" (x: half)    -> half { return math.sinh(x) }
 tanh_half        :: proc "c" (x: half)    -> half { return math.tanh(x) }
 acosh_half       :: proc "c" (x: half)    -> half { return math.acosh(x) }
 asinh_half       :: proc "c" (x: half)    -> half { return math.asinh(x) }
 atanh_half       :: proc "c" (x: half)    -> half { return math.atanh(x) }
 sqrt_half        :: proc "c" (x: half)    -> half { return math.sqrt(x) }
 rsqrt_half       :: proc "c" (x: half)    -> half { return 1.0/math.sqrt(x) }
 rcp_half         :: proc "c" (x: half)    -> half { return 1.0/x }
 pow_half         :: proc "c" (x, y: half) -> half { return math.pow(x, y) }
 exp_half         :: proc "c" (x: half)    -> half { return math.exp(x) }
 log_half         :: proc "c" (x: half)    -> half { return math.ln(x) }
 log2_half        :: proc "c" (x: half)    -> half { return math.log(x, 2) }
 log10_half       :: proc "c" (x: half)    -> half { return math.log(x, 10) }
 exp2_half        :: proc "c" (x: half)    -> half { return math.pow(half(2), x) }
 sign_half        :: proc "c" (x: half)    -> half { return math.sign(x) }
 floor_half       :: proc "c" (x: half)    -> half { return math.floor(x) }
 round_half       :: proc "c" (x: half)    -> half { return math.round(x) }
 ceil_half        :: proc "c" (x: half)    -> half { return math.ceil(x) }
 isnan_half       :: proc "c" (x: half)    -> bool  { return math.classify(x) == .NaN}
 fmod_half        :: proc "c" (x, y: half) -> half { return math.mod(x, y) }
