...
fe_is_odd :: proc(arg1: ^Montgomery_Domain_Field_Element) -> int {
	tmp: Non_Montgomery_Domain_Field_Element = ---
	defer crypto.zero_explicit(&tmp, size_of(tmp))
...
fe_cond_swap :: #force_no_inline proc(out1, out2: ^Montgomery_Domain_Field_Element, arg1: int) {
...
fe_cond_negate :: proc(out1, arg1: ^Montgomery_Domain_Field_Element, ctrl: int) {
...
fe_inv :: proc(out1, arg1: ^Montgomery_Domain_Field_Element) {
