...
fe_a_p256r1 :: proc(fe: ^Field_Element_p256r1) {
...
fe_b_p256r1 :: proc(fe: ^Field_Element_p256r1) {
...
fe_gen_x_p256r1 :: proc(fe: ^Field_Element_p256r1) {
...
fe_gen_y_p256r1 :: proc(fe: ^Field_Element_p256r1) {
...
fe_a_p384r1 :: proc(fe: ^Field_Element_p384r1) {
...
fe_b_p384r1 :: proc(fe: ^Field_Element_p384r1) {
...
fe_gen_x_p384r1 :: proc(fe: ^Field_Element_p384r1) {
...
fe_gen_y_p384r1 :: proc(fe: ^Field_Element_p384r1) {
...
fe_is_zero_p256r1 :: proc(fe: ^Field_Element_p256r1) -> int {
    return int(subtle.u64_is_zero(p256r1.fe_non_zero(fe)))
}


fe_is_zero_p384r1 :: proc(fe: ^Field_Element_p384r1) -> int {
