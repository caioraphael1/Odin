...
foreign lib {
    ...
    GuiScrollPanel      :: proc(bounds: Rectangle, text: cstring, content: Rectangle, scroll: ^[2]f32, view: ^Rectangle) -> c.int --- // Scroll Panel control
    ...
    GuiGrid             :: proc(bounds: Rectangle, text: cstring, spacing: f32, subdivs: c.int, mouseCell: ^[2]f32) -> c.int --- // Grid control, returns mouse cell position
    ...
    GuiColorPickerHSV   :: proc(bounds: Rectangle, text: cstring, colorHsv: ^[3]f32) -> c.int ---            // Color Picker control that avoids conversion to RGB on each call (multiple color controls)
    GuiColorPanelHSV    :: proc(bounds: Rectangle, text: cstring, colorHsv: ^[3]f32) -> c.int ---            // Color Panel control that returns HSV color value, used by GuiColorPickerHSV()
    //----------------------------------------------------------------------------------------------------------
}
