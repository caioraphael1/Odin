...
foreign ObjC {
    __sel_registerName       :: proc "c" (name: cstring) -> objc_SEL ---
    ...
    __objc_allocateClassPair    :: proc "c" (superclass: objc_Class, name: cstring, extraBytes: uint) -> objc_Class ---
    __objc_registerClassPair    :: proc "c" (cls : objc_Class) ---
    __class_addMethod           :: proc "c" (cls: objc_Class, name: objc_SEL, imp: objc_IMP, types: cstring) -> objc_BOOL ---
    __class_addIvar             :: proc "c" (cls: objc_Class, name: cstring, size: uint, alignment: u8, types: cstring) -> objc_BOOL ---
    __class_getInstanceVariable :: proc "c" (cls : objc_Class, name: cstring) -> objc_Ivar ---
    class_getInstanceSize       :: proc "c" (cls : objc_Class) -> uint ---
    class_getSuperclass         :: proc "c" (cls : objc_Class) -> objc_Class ---
    __ivar_getOffset            :: proc "c" (v: objc_Ivar) -> uintptr ---
    __object_getClass           :: proc "c" (obj: objc_id) -> objc_Class ---
}
...
foreign libSystem {
    ...
    __Block_object_assign  :: proc "c" (rawptr, rawptr, i32) ---
    __Block_object_dispose :: proc "c" (rawptr, i32) ---
}
