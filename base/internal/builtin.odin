...
*/
DUSK_ARCH_STRING                :: DUSK_ARCH_STRING
...
*/
DUSK_BUILD_MODE                 :: DUSK_BUILD_MODE

/*
    A `string` containing the name of the folder that contains the entry point,
    e.g. for `%DUSK_ROOT%/examples/demo`, this would contain `demo`.
*/
DUSK_BUILD_PROJECT_NAME         :: DUSK_BUILD_PROJECT_NAME

/*
    An `i64` containing the time at which the executable was compiled, in nanoseconds.
    This is compatible with the `time.Time` type, i.e. `time.Time{_nsec=DUSK_COMPILE_TIMESTAMP}`
*/
DUSK_COMPILE_TIMESTAMP          :: DUSK_COMPILE_TIMESTAMP

/*
    `true` if the `-debug` command line switch is passed, which enables debug info generation.
*/
DUSK_DEBUG                      :: DUSK_DEBUG
...
/*
    ...
    Possible values are: `.Default` (Dusk-style) and `.Unix`.
*/
DUSK_ERROR_POS_STYLE            :: DUSK_ERROR_POS_STYLE

/*
    `true` if the `-foreign-error-procedures` command line switch is passed,
    which inhibits generation of internal error procedures, so that they can be in a separate compilation unit.
*/
DUSK_FOREIGN_ERROR_PROCEDURES   :: DUSK_FOREIGN_ERROR_PROCEDURES
...
*/
DUSK_MICROARCH_STRING           :: DUSK_MICROARCH_STRING
...
/*
    ...
    If `DUSK_OPTIMIZATION_MODE` is anything other than `.None` or `.Minimal`, the compiler will also perform a unity build,
    and `DUSK_USE_SEPARATE_MODULES` will be set to `false` as a result.
*/
DUSK_OPTIMIZATION_MODE          :: DUSK_OPTIMIZATION_MODE
...
*/
DUSK_PLATFORM_SUBTARGET         :: DUSK_PLATFORM_SUBTARGET
...
*/
DUSK_SANITIZER_FLAGS            :: DUSK_SANITIZER_FLAGS
...
*/
DUSK_VERSION_HASH               :: DUSK_VERSION_HASH
...
*/
DUSK_WINDOWS_SUBSYSTEM          :: DUSK_WINDOWS_SUBSYSTEM
...
/*
    ...
    See also: https://learn.microsoft.com/en-us/windows/win32/api/winnt/ns-winnt-image_optional_header64
*/
DUSK_WINDOWS_SUBSYSTEM_STRING   :: DUSK_WINDOWS_SUBSYSTEM_STRING

/*
    `true` if LLVM supports the f16 type.
*/
__DUSK_LLVM_F16_SUPPORTED       :: __DUSK_LLVM_F16_SUPPORTED
