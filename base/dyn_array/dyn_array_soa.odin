...
make_soa_dynamic_array_len :: proc($T: typeid/#soa[dynamic]$E, #any_int length: int, allocator: mem.Allocator, loc := #caller_location) -> (array: T, err: mem.Allocator_Error) {
    array.allocator = allocator
    resize_soa(&array, length, loc) or_return
    return array, nil
}

make_soa_dynamic_array_len_cap :: proc($T: typeid/#soa[dynamic]$E, #any_int length, capacity: int, allocator: mem.Allocator, loc := #caller_location) -> (array: T, err: mem.Allocator_Error) {
...
resize_soa :: proc(array: ^$T/#soa[dynamic]$E, #any_int length: int, loc := #caller_location) -> mem.Allocator_Error {
    if array == nil {
        return nil
    }
...
non_zero_resize_soa :: proc(array: ^$T/#soa[dynamic]$E, #any_int length: int, loc := #caller_location) -> mem.Allocator_Error {
    if array == nil {
        return nil
    }
...
reserve_soa :: proc(array: ^$T/#soa[dynamic]$E, #any_int capacity: int, loc := #caller_location) -> mem.Allocator_Error {
    return _reserve_soa(array, capacity, true, loc)
}

non_zero_reserve_soa :: proc(array: ^$T/#soa[dynamic]$E, #any_int capacity: int, loc := #caller_location) -> mem.Allocator_Error {
    return _reserve_soa(array, capacity, false, loc)
}

_reserve_soa :: proc(array: ^$T/#soa[dynamic]$E, capacity: int, zero_memory: bool, loc := #caller_location) -> mem.Allocator_Error {
    if array == nil {
        return nil
    }
...
append_soa_elem :: proc(array: ^$T/#soa[dynamic]$E, #no_broadcast arg: E, loc := #caller_location) -> (n: int, err: mem.Allocator_Error) {
    return _append_soa_elem(array, true, arg, loc)
}

non_zero_append_soa_elem :: proc(array: ^$T/#soa[dynamic]$E, #no_broadcast arg: E, loc := #caller_location) -> (n: int, err: mem.Allocator_Error) {
    return _append_soa_elem(array, false, arg, loc)
}

_append_soa_elem :: proc(array: ^$T/#soa[dynamic]$E, zero_memory: bool, #no_broadcast arg: E, loc := #caller_location) -> (n: int, err: mem.Allocator_Error) {
    if array == nil {
        return 0, nil
    }
...
append_soa_elems :: proc(array: ^$T/#soa[dynamic]$E, #no_broadcast args: ..E, loc := #caller_location) -> (n: int, err: mem.Allocator_Error) {
    return _append_soa_elems(array, true, args=args, loc=loc)
}

non_zero_append_soa_elems :: proc(array: ^$T/#soa[dynamic]$E, #no_broadcast args: ..E, loc := #caller_location) -> (n: int, err: mem.Allocator_Error) {
    return _append_soa_elems(array, false, args=args, loc=loc)
}


_append_soa_elems :: proc(array: ^$T/#soa[dynamic]$E, zero_memory: bool, #no_broadcast args: []E, loc := #caller_location) -> (n: int, err: mem.Allocator_Error) {
    if array == nil {
        return
    }
...
append_nothing_soa :: proc(array: ^$T/#soa[dynamic]$E, loc := #caller_location) -> (n: int, err: mem.Allocator_Error) {
    if array == nil {
        return 0, nil
    }
    prev_len := len(array)
