...
gb_internal lbValue lb_emit_arith(lbProcedure *p, TokenKind op, lbValue lhs, lbValue rhs, Type *type) {
    if (is_type_array_like(lhs.type) || is_type_array_like(rhs.type)) {
        ...
        if (op == Token_Quo) {
            ...
            case 2: return lb_emit_internal_call(p, "__complex32_quo", args);
            case 4: return lb_emit_internal_call(p, "__complex64_quo", args);
            case 8: return lb_emit_internal_call(p, "__complex128_quo", args);
        ...
        if (op == Token_Add || op == Token_Sub) {
            ...
            case 16: return lb_emit_internal_call(p, "__quaternion64_mul", args);
            case 32: return lb_emit_internal_call(p, "__quaternion128_mul", args);
            case 64: return lb_emit_internal_call(p, "__quaternion256_mul", args);
            default: GB_PANIC("Unknown float type"); break;
            }
            ...
            switch (8*type_size_of(ft)) {
            case 16: return lb_emit_internal_call(p, "__quaternion64_quo", args);
            case 32: return lb_emit_internal_call(p, "__quaternion128_quo", args);
            case 64: return lb_emit_internal_call(p, "__quaternion256_quo", args);
            default: GB_PANIC("Unknown float type"); break;
            }
        }
    }
...
gb_internal lbValue lb_emit_conv(lbProcedure *p, lbValue value, Type *t) {
    ...
    if (are_types_identical(src, t_cstring) && are_types_identical(dst, t_string)) {
        ...
        args[0] = c;
        lbValue s = lb_emit_internal_call(p, "__cstring_to_string", args);
    ...
    if (are_types_identical(src, t_cstring16) && are_types_identical(dst, t_string16)) {
        ...
        auto args = array_make<lbValue>(temporary_allocator(), 1);
        args[0] = c;
        lbValue s = lb_emit_internal_call(p, "__cstring16_to_string16", args);
        return lb_emit_conv(p, s, dst);
    }
...
gb_internal lbValue lb_compare_records(lbProcedure *p, TokenKind op_kind, lbValue left, lbValue right, Type *type) {
    ...
    if (is_type_simple_compare(type)) {
        ...
        res = lb_emit_internal_call(p, "__mem_equal", args);
    } else {
...
gb_internal lbValue lb_emit_comp(lbProcedure *p, TokenKind op_kind, lbValue left, lbValue right) {
    ...
    if (is_type_string16(a) || is_type_cstring16(a)) {
        if (is_type_cstring16(a) && is_type_cstring16(b)) {
            ...
            switch (op_kind) {
            case Token_CmpEq: internal_procedure = "__cstring16_eq"; break;
            case Token_NotEq: internal_procedure = "__cstring16_ne"; break;
            case Token_Lt:    internal_procedure = "__cstring16_lt"; break;
            case Token_Gt:    internal_procedure = "__cstring16_gt"; break;
            case Token_LtEq:  internal_procedure = "__cstring16_le"; break;
            case Token_GtEq:  internal_procedure = "__cstring16_ge"; break;
            }
        ...
        char const *internal_procedure = nullptr;
        switch (op_kind) {
        case Token_CmpEq: internal_procedure = "__string16_eq"; break;
        case Token_NotEq: internal_procedure = "__string16_ne"; break;
        case Token_Lt:    internal_procedure = "__string16_lt"; break;
        case Token_Gt:    internal_procedure = "__string16_gt"; break;
        case Token_LtEq:  internal_procedure = "__string16_le"; break;
        case Token_GtEq:  internal_procedure = "__string16_ge"; break;
        }
        GB_ASSERT(internal_procedure != nullptr);
    ...
    if (is_type_string(a)) {
        ...
        if (is_type_cstring(a) && is_type_cstring(b)) {
            ...
            char const *internal_procedure = nullptr;
            switch (op_kind) {
            case Token_CmpEq: internal_procedure = "__cstring_eq"; break;
            case Token_NotEq: internal_procedure = "__cstring_ne"; break;
            case Token_Lt:    internal_procedure = "__cstring_lt"; break;
            case Token_Gt:    internal_procedure = "__cstring_gt"; break;
            case Token_LtEq:  internal_procedure = "__cstring_le"; break;
            case Token_GtEq:  internal_procedure = "__cstring_ge"; break;
            }
            GB_ASSERT(internal_procedure != nullptr);
        ...
        case Token_GtEq:  internal_procedure = "__string_ge"; break;
        }
        GB_ASSERT(internal_procedure != nullptr);
    ...
    case Type_BitSet:
        {
            ...
            if (is_type_array(u)) {
                ...
                lbValue val = lb_emit_internal_call(p, "__mem_compare_zero", args);
        ...
        if (is_type_tuple(tv.type)) {
            ...
            if (is_type_union(t)) {
                ...
                if (do_type_check) {
                    ...
                    char const *name = "__type_assertion_check";
                    lb_emit_internal_call(p, name, args);
                }
...
gb_internal lbAddr lb_build_addr_internal(lbProcedure *p, Ast *expr) {
    ...
    case_ast_node(se, SelectorExpr, expr);
        ...
        if (sel_node->kind == Ast_Ident) {
            ...
            GB_ASSERT(sel.entity != nullptr);
            if (sel.pseudo_field && (sel.entity->kind == Entity_Procedure)) {
                Entity *e = entity_of_node(sel_node);
                GB_ASSERT(e->kind == Entity_Procedure);
                return lb_addr(lb_find_value_from_entity(p->module, e));
            }
