...
gb_internal void add_comparison_procedures_for_fields(CheckerContext *c, Type *t) {
    ...
    case Type_Basic:
        switch (t->Basic.kind) {
        case Basic_complex32:
            add_package_dependency(c, "internal", "__complex32_eq");
            add_package_dependency(c, "internal", "__complex32_ne");
            break;
        case Basic_complex64:
            add_package_dependency(c, "internal", "__complex64_eq");
            add_package_dependency(c, "internal", "__complex64_ne");
            break;
        case Basic_complex128:
            add_package_dependency(c, "internal", "__complex128_eq");
            add_package_dependency(c, "internal", "__complex128_ne");
            break;
        case Basic_quaternion64:
            add_package_dependency(c, "internal", "__quaternion64_eq");
            add_package_dependency(c, "internal", "__quaternion64_ne");
            break;
        case Basic_quaternion128:
            add_package_dependency(c, "internal", "__quaternion128_eq");
            add_package_dependency(c, "internal", "__quaternion128_ne");
            break;
        case Basic_quaternion256:
            add_package_dependency(c, "internal", "__quaternion256_eq");
            add_package_dependency(c, "internal", "__quaternion256_ne");
            break;
        case Basic_cstring:
            add_package_dependency(c, "internal", "__cstring_eq");
            add_package_dependency(c, "internal", "__cstring_ne");
            break;
        case Basic_string:
            add_package_dependency(c, "internal", "__string_eq");
            add_package_dependency(c, "internal", "__string_ne");
            break;
        case Basic_cstring16:
            add_package_dependency(c, "internal", "__cstring16_eq");
            add_package_dependency(c, "internal", "__cstring16_ne");
            break;
        case Basic_string16:
            add_package_dependency(c, "internal", "__string16_eq");
            add_package_dependency(c, "internal", "__string16_ne");
            break;
        }
        break;
    case Type_Struct:
    ...
    if (err_str != nullptr) {
        ...
        if (x->mode == Addressing_Constant &&
            ...
            if (is_type_cstring(x->type) && is_type_cstring(y->type)) {
                switch (op) {
                case Token_CmpEq: add_package_dependency(c, "internal", "__cstring_eq"); break;
                case Token_NotEq: add_package_dependency(c, "internal", "__cstring_ne"); break;
                case Token_Lt:    add_package_dependency(c, "internal", "__cstring_lt"); break;
                case Token_Gt:    add_package_dependency(c, "internal", "__cstring_gt"); break;
                case Token_LtEq:  add_package_dependency(c, "internal", "__cstring_le"); break;
                case Token_GtEq:  add_package_dependency(c, "internal", "__cstring_gt"); break;
                }
            } else if (is_type_cstring16(x->type) && is_type_cstring16(y->type)) {
                switch (op) {
                case Token_CmpEq: add_package_dependency(c, "internal", "__cstring16_eq"); break;
                case Token_NotEq: add_package_dependency(c, "internal", "__cstring16_ne"); break;
                case Token_Lt:    add_package_dependency(c, "internal", "__cstring16_lt"); break;
                case Token_Gt:    add_package_dependency(c, "internal", "__cstring16_gt"); break;
                case Token_LtEq:  add_package_dependency(c, "internal", "__cstring16_le"); break;
                case Token_GtEq:  add_package_dependency(c, "internal", "__cstring16_gt"); break;
                }
            } else if (is_type_string16(x->type) || is_type_string16(y->type)) {
                switch (op) {
                case Token_CmpEq: add_package_dependency(c, "internal", "__string16_eq"); break;
                case Token_NotEq: add_package_dependency(c, "internal", "__string16_ne"); break;
                case Token_Lt:    add_package_dependency(c, "internal", "__string16_lt"); break;
                case Token_Gt:    add_package_dependency(c, "internal", "__string16_gt"); break;
                case Token_LtEq:  add_package_dependency(c, "internal", "__string16_le"); break;
                case Token_GtEq:  add_package_dependency(c, "internal", "__string16_gt"); break;
                }
            } else if (is_type_string(x->type) || is_type_string(y->type)) {
                switch (op) {
                case Token_CmpEq: add_package_dependency(c, "internal", "__string_eq"); break;
                case Token_NotEq: add_package_dependency(c, "internal", "__string_ne"); break;
                case Token_Lt:    add_package_dependency(c, "internal", "__string_lt"); break;
                case Token_Gt:    add_package_dependency(c, "internal", "__string_gt"); break;
                case Token_LtEq:  add_package_dependency(c, "internal", "__string_le"); break;
                case Token_GtEq:  add_package_dependency(c, "internal", "__string_gt"); break;
                }
            } else if (is_type_complex(x->type) || is_type_complex(y->type)) {
                switch (op) {
                case Token_CmpEq:
                    switch (8*size) {
                    case 64:  add_package_dependency(c, "internal", "__complex64_eq");  break;
                    case 128: add_package_dependency(c, "internal", "__complex128_eq"); break;
                    }
                    break;
                case Token_NotEq:
                    switch (8*size) {
                    case 64:  add_package_dependency(c, "internal", "__complex64_ne");  break;
                    case 128: add_package_dependency(c, "internal", "__complex128_ne"); break;
                    }
                    break;
                }
                ...
                case Token_CmpEq:
                    switch (8*size) {
                    case 128: add_package_dependency(c, "internal", "__quaternion128_eq");  break;
                    case 256: add_package_dependency(c, "internal", "__quaternion256_eq"); break;
                    }
                    break;
                case Token_NotEq:
                    switch (8*size) {
                    case 128: add_package_dependency(c, "internal", "__quaternion128_ne");  break;
                    case 256: add_package_dependency(c, "internal", "__quaternion256_ne"); break;
                    }
                    break;
                }
            }
...
gb_internal bool check_is_castable_to(CheckerContext *c, Operand *operand, Type *y) {
    ...
    if (are_types_identical(src, t_cstring) && are_types_identical(dst, t_string)) {
        if (operand->mode != Addressing_Constant) {
            add_package_dependency(c, "internal", "__cstring_to_string");
        }
        return true;
    }
    // cstring16 -> string16
    if (are_types_identical(src, t_cstring16) && are_types_identical(dst, t_string16)) {
        if (operand->mode != Addressing_Constant) {
            add_package_dependency(c, "internal", "__cstring16_to_string16");
        }
        return true;
    }
    ...
    if (is_type_untyped(x->type)) {
        ...
        if (src != dst) {
            ...
            if (is_type_integer_128bit(src) && is_type_float(dst)) {
                add_package_dependency(c, "internal", "__floattidf_unsigned", REQUIRE);
                add_package_dependency(c, "internal", "__floattidf",        REQUIRE);
            } else if (is_type_integer_128bit(dst) && is_type_float(src)) {
                add_package_dependency(c, "internal", "__fixunsdfti",         REQUIRE);
                add_package_dependency(c, "internal", "__fixunsdfdi",         REQUIRE);
            } else if (src == t_f16 && is_type_float(dst)) {
                add_package_dependency(c, "internal", "__gnu_h2f_ieee",       REQUIRE);
                add_package_dependency(c, "internal", "__extendhfsf2",        REQUIRE);
            } else if (is_type_float(dst) && dst == t_f16) {
                add_package_dependency(c, "internal", "__truncsfhf2",         REQUIRE);
                add_package_dependency(c, "internal", "__truncdfhf2",         REQUIRE);
                add_package_dependency(c, "internal", "__gnu_f2h_ieee",       REQUIRE);
            }
        }
...
gb_internal void check_binary_expr_dependency(CheckerContext *c, Token op, Type *bt, bool REQUIRE) {
    if (op.kind == Token_Mod    || op.kind == Token_ModEq ||
        ...
        case Basic_u128: add_package_dependency(c, "internal", "__umodti3", REQUIRE); break;
        case Basic_i128: add_package_dependency(c, "internal", "__modti3",  REQUIRE); break;
        }
    } else if (op.kind == Token_Quo || op.kind == Token_QuoEq) {
        if (bt->kind == Type_Basic) switch (bt->Basic.kind) {
        case Basic_complex32:     add_package_dependency(c, "internal", "__complex32_quo");     break;
        case Basic_complex64:     add_package_dependency(c, "internal", "__complex64_quo");     break;
        case Basic_complex128:    add_package_dependency(c, "internal", "__complex128_quo");    break;
        case Basic_quaternion64:  add_package_dependency(c, "internal", "__quaternion64_quo");  break;
        case Basic_quaternion128: add_package_dependency(c, "internal", "__quaternion128_quo"); break;
        case Basic_quaternion256: add_package_dependency(c, "internal", "__quaternion256_quo"); break;

        case Basic_u128: add_package_dependency(c, "internal", "__udivti3", REQUIRE); break;
        case Basic_i128: add_package_dependency(c, "internal", "__divti3",  REQUIRE); break;
        }
    } else if (op.kind == Token_Mul || op.kind == Token_MulEq) {
        if (bt->kind == Type_Basic) switch (bt->Basic.kind) {
        case Basic_quaternion64:  add_package_dependency(c, "internal", "__quaternion64_mul");  break;
        case Basic_quaternion128: add_package_dependency(c, "internal", "__quaternion128_mul"); break;
        case Basic_quaternion256: add_package_dependency(c, "internal", "__quaternion256_mul"); break;


        case Basic_u128:
        case Basic_i128:
            if (is_arch_wasm()) {
                add_package_dependency(c, "internal", "__multi3", REQUIRE);
            }
            break;
        }
        ...
        case Basic_i128:
            if (is_arch_wasm()) {
                add_package_dependency(c, "internal", "__ashlti3", REQUIRE);
            }
            break;
        }
        ...
        case Basic_i128:
            if (is_arch_wasm()) {
                add_package_dependency(c, "internal", "__lshrti3", REQUIRE);
            }
            break;
        }
    }
...
gb_internal Entity *check_selector(CheckerContext *c, Operand *operand, Ast *node, Type *type_hint) {
    ...
    if (op_expr->kind == Ast_Ident) {
        ...
        if (e != nullptr && (e->kind == Entity_Procedure) && selector->kind == Ast_Ident) {
    ...
    if (entity->flags & EntityFlag_BitFieldField) {
        add_package_dependency(c, "internal", "__write_bits");
        add_package_dependency(c, "internal", "__read_bits");
    }
